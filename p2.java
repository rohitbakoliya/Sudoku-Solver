...
class p2
{
    public static void main()throws IOException
    {
        ...
        System.out.println("ENTER THE NUMBERS IN THE SUDOKU ACCORDING TO THE GIVEN FORMAT : ROW,COLUMN=NUMBER.EXAMPLE : 2,5=8 AND TYPE 'DONE' WHEN FINISHED");
        for(int m3=1;m3>0;m3++)
        {
